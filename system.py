...
class AadhaarSystem:
    ...
    def recognize(self, img):
        img = cv2.resize(img, (320, 240))   # HUGE PERFORMANCE BOOST
        faces = self.app.get(img)  # speed fix
        if not faces:
            return []   # FIX
        ...
        if best_score > 0.6:   # improved threshold
        ...
        return[{
                ...
                "bbox": [x1, y1, x2, y2],
                "photo": base64.b64encode(meta.get("photo", b"")).decode() if meta.get("photo") else None,
